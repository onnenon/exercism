defmodule ZebraPuzzle do
  ...
  @doc """
  Checks if two elements are adjacent (next to each other) in their respective lists
  """
  def adjacent?(list1, item1, list2, item2) do
  ...
  @doc """
  Checks if the first item is immediately to the left of the second item
  """
  def left_of?(list1, item1, list2, item2) do
    indices1 = find_indices(list1, item1)
    indices2 = find_indices(list2, item2)
  ...
  @doc """
  Checks if two items are at the same position in their respective lists
  """
  def coincident?(list1, item1, list2, item2) do
    indices1 = find_indices(list1, item1)
    indices2 = find_indices(list2, item2)
  ...
  @doc """
  Transpose a list of lists - convert rows to columns
  """
